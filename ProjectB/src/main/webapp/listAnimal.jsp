...
<body>
	...
	<div>
		...
		<label> <input type="radio" id="dogRadio" name="animalType"
			value="개"> <label for="dogRadio">개</label> <input
			type="radio" id="catRadio" name="animalType" value="고양이"> <label
			for="catRadio">고양이</label> <input type="radio" id="othersRadio"
			name="animalType" value="기타"> <label for="othersRadio">기타</label>
		</label>
	...
	<div>
		<div id="animalDetails" class="flex-1 flex flex-col gap-1 p-2" style="width: 500px;"></div>
		<!-- 검색리스트 -->
